...
class ObjectService:
    ...
    def deselect_and_deactivate_all():
        ...
        if bpy.context.object:
            try:
                ...
                print("Tried mode_set / unselect on non-existing object")
    ...
    @staticmethod
    def get_selected_objects(exclude_non_mh_objects=False, exclude_mesh_objects=False, exclude_armature_objects=False,
                             exclude_meta_objects=True):
    ...
    def object_is_body_proxy(blender_object):
        ...
        return ObjectService.object_is(blender_object, "Proxymesh") or ObjectService.object_is(blender_object,
                                                                                               "Proxymeshes")
